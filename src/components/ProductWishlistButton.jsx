...
export default function ProductWishlistButton() {
  ...
  return (
    <button
      ...
      className={cn(
        "group/wishlist absolute right-2.5 top-2.5 z-10 hidden size-7 items-center justify-center rounded-full border border-border/60 bg-background/90 p-0 text-foreground shadow-xs backdrop-blur-md outline-none transition-[transform,opacity,border-color,box-shadow,color] duration-200 ease-out hover:scale-[1.03] active:scale-[0.96] focus-visible:ring-2 focus-visible:ring-ring/50 md:inline-flex md:hover:border-destructive/30 md:hover:text-destructive md:hover:shadow-sm after:absolute after:-inset-2 after:content-['']",
